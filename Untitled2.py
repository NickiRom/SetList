...
def DiGraph(songdatalist, dist_matrix, playlist):
    ...
    improvement = int((avg_shuffle - minval)/shufflerange*100)
    minval = round(minval, 2)
    avg_shuffle = round(avg_shuffle, 2)
    
    return bestpath, minval, shuffle, avg_shuffle, improvement

# <codecell>

plid = 'pl150355735111270912'
...
bestpath, minval, shuffle, avg_shuffle, improvement = DiGraph(songdatalist, dist_matrix, playlist)
